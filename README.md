...
|---|---|---|---|
| 1 | Jasraj Raval | Normalize: 3-element → 1-element list | Bad |
| 2 | Jack Sweeney | MaxPool kernel_size: 2 → 3 | Bad |
| 3 | Jasraj Raval | Learning rate: 0.001 → 10.0 | Bad |
| 4 | Jack Sweeney | Dropout: p=0.5 → p=1.0 | Bad |
| 5 | Jasraj Raval | CrossEntropyLoss args swapped | Bad |
| 6 | Jack Sweeney | FC hidden size: 256 → 512 (mismatch) | Bad |
| 7 | Jasraj Raval | EPOCHS: 20 → 0 | Bad |
| 8 | Jack Sweeney | RandomRotation: 10° → 180° | Bad |
| 9 | Jasraj Raval | optimizer.zero_grad() removed | Bad |
